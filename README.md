...
| Reserva desde el portal (la paciente elige el horario; confirmada si es del plan, tentativa con link de MercadoPago y retención de 30 min si tiene cargo; vencimiento automático) | ✅ R-23, bots `som-reservar-portal` / `som-vencer-reservas` ([`docs/bots.md`](docs/bots.md#reserva-desde-el-portal-r-23-som-reservar-portal-y-som-vencer-reservas)); pantalla del portal: [`docs/handoff-app-pb100d.md`](docs/handoff-app-pb100d.md) |
| Agenda por profesional (`PractitionerRole` + `Schedule` + horarios libres de 30 min; la reserva ocupa la franja con escritura condicional) | ✅ R-22 (validada 26/09/2026), cron `som-generar-agenda` ([`docs/bots.md`](docs/bots.md#agenda-por-profesional-r-22-som-generar-agenda)); disponibilidad (por modalidad) y consultorio de los tres profesionales cargados |
