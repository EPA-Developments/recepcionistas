...
Genera los entregables .docx del bloque de gestión de sesiones:
  - Segunda Opinión Médica-Gestion-de-Sesiones-Andres.docx  (resumen para Andrés)
  - Segunda Opinión Médica-Guia-Recepcion.docx              (guía para recepcionistas)
...
def doc_andres():
    ...
    titulo(
        doc,
        "Segunda Opinión Médica · Gestión de Sesiones",
    ...
    ruta = os.path.join(OUT, "Segunda Opinión Médica-Gestion-de-Sesiones-Andres.docx")
    doc.save(ruta)
    return ruta
...
def doc_recepcion():
    ...
    titulo(
        ...
        "Planes, sesiones y recordatorios · Segunda Opinión Médica",
    )
    ...
    ruta = os.path.join(OUT, "Segunda Opinión Médica-Guia-Recepcion.docx")
    doc.save(ruta)
    return ruta
