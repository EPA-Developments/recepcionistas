...
| 1b | **Disponibilidad y consultorio de cada profesional** | Cargada la disponibilidad (26/09/2026, `src/config/medicos.ts`): Dr. Barbagelata martes y jueves 14–18 en el **Consultorio 1**; Dr. D'Alessandro lunes, miércoles y viernes 16–20; Dra. Gold miércoles y viernes 08–12. Falta el **consultorio** de lo presencial del Dr. D'Alessandro y de la Dra. Gold (hasta entonces, Recepción elige el consultorio al reservar) y confirmar los horarios de la Dra. Gold. Todas las franjas caen dentro del horario placeholder del centro (ver *Agenda*). | Parcial: consultorios de dos profesionales |
